...
for i in range(0, solver_config.max_iter):
    ...
    for b in range(0, batch_size):
        ...
        solver.net.blobs['mnist_image'].data[b,:] = np.reshape(training_data[0][k],(28,28)).astype(float)/255.0
        solver.net.blobs['label'].data[b] = training_data[1][k]
    # Train one step
    loss = solver.step(1)
    #print(solver.net.blobs['observed_count'].data)
